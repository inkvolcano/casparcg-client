...
There are thirty-seven test suites and a syntax checker. Twenty-three commands that each take a
...
SUITES = [
    ...
    ('test-preview', False, 'preview audio levels: peaks, unknown-vs-silent, and meter ballistics'),
    ('test-ograf',   False, 'EBU OGraf manifests: what loads, what is refused, and the default data'),
    ...
    ('test-shotbox', False, 'what the Shotbox panel takes, how many, and where a moved row lands'),
    ...
    ('test-bootstrap', False, 'the standalone updater, for a client too old to update itself'),
