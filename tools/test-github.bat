@echo off
REM Builds and runs tools/test-github.cpp: the real RelayClient pulling from
REM tools/mock-github.php, started for the test on a spare port. Needs PHP.
...
set HERE=%~dp0
set OUT=%TEMP%\casparcg-test-github
