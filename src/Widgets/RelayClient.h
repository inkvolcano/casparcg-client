...
class WIDGETS_EXPORT RelayClient : public QObject
{
    ...
    public:
        ...
        // What this build calls itself, for the check-in to report. Set by the
        // application at startup: the version header is generated by CMake and this
        // class is compiled by test harnesses that have no build directory.
        static void setClientVersion(const QString& version, const QString& build);
