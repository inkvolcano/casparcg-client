...
void RundownPrintWidget::deviceChanged(const DeviceChangedEvent& event)
{
    // This event is not for us.
    if (!this->selected)
        return;
...
void RundownPrintWidget::setCompactView(bool compactView)
{
    if (compactView)
    {
...
void RundownPrintWidget::readProperties(boost::property_tree::wptree& pt)
{
...
LibraryModel* RundownPrintWidget::getLibraryModel()
{
    return &this->model;
}

void RundownPrintWidget::setSelected(bool selected)
{
...
void RundownPrintWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownPrintWidget::deviceAdded(CasparDevice& device)
{
...
void RundownPrintWidget::setRundownDisabled(bool disabled)
{
