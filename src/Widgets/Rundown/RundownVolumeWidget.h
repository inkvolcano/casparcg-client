...
class WIDGETS_EXPORT RundownVolumeWidget : public QWidget, Ui::RundownVolumeWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownVolumeWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
