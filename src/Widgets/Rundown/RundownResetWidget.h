...
#include "ui_RundownResetWidget.h"
...
class WIDGETS_EXPORT RundownResetWidget : public QWidget, Ui::RundownResetWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownResetWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
