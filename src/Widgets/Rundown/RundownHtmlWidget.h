...
#include "ui_RundownHtmlWidget.h"
...
class WIDGETS_EXPORT RundownHtmlWidget : public QWidget, Ui::RundownHtmlWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT
