...
#include "ui_RundownRouteVideolayerWidget.h"
...
class WIDGETS_EXPORT RundownRouteVideolayerWidget : public QWidget, Ui::RundownRouteVideolayerWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownRouteVideolayerWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
