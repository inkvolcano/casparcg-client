...
#include "ui_RundownSaturationWidget.h"
...
class WIDGETS_EXPORT RundownSaturationWidget : public QWidget, Ui::RundownSaturationWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownSaturationWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
