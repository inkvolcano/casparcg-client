...
#include "ui_RundownAnchorWidget.h"
...
class WIDGETS_EXPORT RundownAnchorWidget : public QWidget, Ui::RundownAnchorWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:  
        explicit RundownAnchorWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
