...
#include "ui_RundownContrastWidget.h"
...
class WIDGETS_EXPORT RundownContrastWidget : public QWidget, Ui::RundownContrastWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownContrastWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
