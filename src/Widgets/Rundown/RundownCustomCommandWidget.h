...
#include "ui_RundownCustomCommandWidget.h"
...
class WIDGETS_EXPORT RundownCustomCommandWidget : public QWidget, Ui::RundownCustomCommandWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownCustomCommandWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
