...
#include "ui_RundownOpacityWidget.h"
...
class WIDGETS_EXPORT RundownOpacityWidget : public QWidget, Ui::RundownOpacityWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownOpacityWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
                                      bool active = false, bool inGroup = false, bool compcatView = false);
