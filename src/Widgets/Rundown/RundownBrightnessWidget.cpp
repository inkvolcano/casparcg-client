...
AbstractRundownWidget* RundownBrightnessWidget::clone()
{
    RundownBrightnessWidget* widget = new RundownBrightnessWidget(this->model, this->parentWidget(), this->color, this->active,
...
void RundownBrightnessWidget::clearDelayedCommands()
{
    this->itemScheduler.cancel();
}

void RundownBrightnessWidget::setUsed(bool used)
{
    if (used)
    {
...
void RundownBrightnessWidget::executePlayPreview()
{
    ...
    if (deviceModel != NULL && deviceModel->getPreviewChannel() > 0)
    {
        const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
        if (device != NULL && device->isConnected())
            device->setBrightness(deviceModel->getPreviewChannel(), this->command.getVideolayer(), this->command.getBrightness(),
                                  this->command.getTransitionDuration(), this->command.getTween(), this->command.getDefer());
    }
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        if (model.getPreviewChannel() > 0)
        {
            const QSharedPointer<CasparDevice>  deviceShadow = DeviceManager::getInstance().getDeviceByName(model.getName());
            if (deviceShadow != NULL && deviceShadow->isConnected())
                deviceShadow->setBrightness(model.getPreviewChannel(), this->command.getVideolayer(), this->command.getBrightness(),
                                            this->command.getTransitionDuration(), this->command.getTween(), this->command.getDefer());
        }
    }
}
...
void RundownBrightnessWidget::checkGpiConnection()
{
...
void RundownBrightnessWidget::checkDeviceConnection()
{
    const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device == NULL)
...
void RundownBrightnessWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownBrightnessWidget::deviceConnectionStateChanged(CasparDevice& device)
{
    Q_UNUSED(device);
...
void RundownBrightnessWidget::deviceAdded(CasparDevice& device)
{
...
void RundownBrightnessWidget::stopControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::playControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::updateControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::clearControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::clearVideolayerControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::clearChannelControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownBrightnessWidget::setRundownDisabled(bool disabled)
{
