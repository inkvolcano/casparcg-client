...
#include "ui_RundownRotationWidget.h"
...
class WIDGETS_EXPORT RundownRotationWidget : public QWidget, Ui::RundownRotationWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownRotationWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
