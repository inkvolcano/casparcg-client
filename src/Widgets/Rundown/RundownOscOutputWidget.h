...
#include "ui_RundownOscOutputWidget.h"
...
class WIDGETS_EXPORT RundownOscOutputWidget : public QWidget, Ui::RundownOscOutputWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownOscOutputWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
