...
void RundownOscOutputWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownOscOutputWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownOscOutputWidget::setRundownDisabled(bool disabled)
{
