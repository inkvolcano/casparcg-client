...
RundownRotationWidget::RundownRotationWidget(const LibraryModel& model, QWidget* parent, const QString& color,
...
void RundownRotationWidget::preview(const PreviewEvent& event)
{
    Q_UNUSED(event);
...
void RundownRotationWidget::labelChanged(const LabelChangedEvent& event)
{
    // This event is not for us.
    if (!this->selected)
        return;
...
void RundownRotationWidget::deviceChanged(const DeviceChangedEvent& event)
{
    // This event is not for us.
    if (!this->selected)
        return;
...
AbstractRundownWidget* RundownRotationWidget::clone()
{
    RundownRotationWidget* widget = new RundownRotationWidget(this->model, this->parentWidget(), this->color, this->active,
...
void RundownRotationWidget::setCompactView(bool compactView)
{
    if (compactView)
    {
...
void RundownRotationWidget::readProperties(boost::property_tree::wptree& pt)
{
...
bool RundownRotationWidget::isInGroup() const
{
    return this->inGroup;
}

AbstractCommand* RundownRotationWidget::getCommand()
{
    return &this->command;
}

LibraryModel* RundownRotationWidget::getLibraryModel()
{
    return &this->model;
}

void RundownRotationWidget::setSelected(bool selected)
{
    this->selected = selected;
}

void RundownRotationWidget::setActive(bool active)
{
    this->active = active;
...
void RundownRotationWidget::setInGroup(bool inGroup)
{
    this->inGroup = inGroup;
    this->labelGroupColor->setVisible(this->inGroup);
}

QString RundownRotationWidget::getColor() const
{
    return this->color;
}
...
void RundownRotationWidget::clearDelayedCommands()
{
    this->itemScheduler.cancel();
}

void RundownRotationWidget::setUsed(bool used)
{
    if (used)
    {
...
void RundownRotationWidget::executeStop()
{
    this->itemScheduler.cancel();

    const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device != NULL && device->isConnected())
        device->setRotation(this->command.getChannel(), this->command.getVideolayer(), 0);
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        if (deviceShadow != NULL && deviceShadow->isConnected())
            deviceShadow->setRotation(this->command.getChannel(), this->command.getVideolayer(), 0);
    }
}

void RundownRotationWidget::executePlay()
{
    const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device != NULL && device->isConnected())
        device->setRotation(this->command.getChannel(), this->command.getVideolayer(), this->command.getRotation(),
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        const QSharedPointer<CasparDevice>  deviceShadow = DeviceManager::getInstance().getDeviceByName(model.getName());
        if (deviceShadow != NULL && deviceShadow->isConnected())
            deviceShadow->setRotation(this->command.getChannel(), this->command.getVideolayer(), this->command.getRotation(),
                                      this->command.getTransitionDuration(), this->command.getTween(), this->command.getDefer());
    }
...
void RundownRotationWidget::executePlayPreview()
{
    ...
    if (deviceModel != NULL && deviceModel->getPreviewChannel() > 0)
    {
        const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
        if (device != NULL && device->isConnected())
            device->setRotation(deviceModel->getPreviewChannel(), this->command.getVideolayer(), this->command.getRotation(),
                                this->command.getTransitionDuration(), this->command.getTween(), this->command.getDefer());
    }
    ...
    foreach (const DeviceModel& model, DeviceManager::getInstance().getDeviceModels())
    {
        ...
        if (model.getPreviewChannel() > 0)
        {
            const QSharedPointer<CasparDevice>  deviceShadow = DeviceManager::getInstance().getDeviceByName(model.getName());
            if (deviceShadow != NULL && deviceShadow->isConnected())
                deviceShadow->setRotation(model.getPreviewChannel(), this->command.getVideolayer(), this->command.getRotation(),
                                          this->command.getTransitionDuration(), this->command.getTween(), this->command.getDefer());
        }
    }
}

void RundownRotationWidget::executeClearVideolayer()
{
    this->itemScheduler.cancel();
...
void RundownRotationWidget::executeClearChannel()
{
    this->itemScheduler.cancel();
...
void RundownRotationWidget::channelChanged(int channel)
{
...
void RundownRotationWidget::videolayerChanged(int videolayer)
{
...
void RundownRotationWidget::delayChanged(int delay)
{
...
void RundownRotationWidget::checkGpiConnection()
{
...
void RundownRotationWidget::checkDeviceConnection()
{
    const QSharedPointer<CasparDevice> device = DeviceManager::getInstance().getDeviceByName(this->model.getDeviceName());
    if (device == NULL)
...
void RundownRotationWidget::configureOscSubscriptions()
{
...
void RundownRotationWidget::allowGpiChanged(bool allowGpi)
{
    Q_UNUSED(allowGpi);
...
void RundownRotationWidget::gpiConnectionStateChanged(bool connected, GpiDevice* device)
{
    Q_UNUSED(connected);
    Q_UNUSED(device);
...
void RundownRotationWidget::remoteTriggerIdChanged(const QString& remoteTriggerId)
{
...
void RundownRotationWidget::deviceConnectionStateChanged(CasparDevice& device)
{
    Q_UNUSED(device);
...
void RundownRotationWidget::deviceAdded(CasparDevice& device)
{
...
void RundownRotationWidget::stopControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::playControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::playNowControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::updateControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::clearControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::clearVideolayerControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::clearChannelControlSubscriptionReceived(const QString& predicate, const QList<QVariant>& arguments)
{
    Q_UNUSED(predicate);
...
void RundownRotationWidget::setRundownDisabled(bool disabled)
{
