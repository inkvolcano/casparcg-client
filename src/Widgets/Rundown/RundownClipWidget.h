...
#include "ui_RundownClipWidget.h"
...
class WIDGETS_EXPORT RundownClipWidget : public QWidget, Ui::RundownClipWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownClipWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
