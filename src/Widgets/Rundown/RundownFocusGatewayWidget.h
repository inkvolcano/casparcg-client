...
#include "ui_RundownFocusGatewayWidget.h"
...
class WIDGETS_EXPORT RundownFocusGatewayWidget : public QWidget, Ui::RundownFocusGatewayWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownFocusGatewayWidget(const LibraryModel& model, QWidget* parent = 0,
                                          const QString& color = Color::DEFAULT_FOCUSGATEWAY_COLOR,
