...
#include "ui_RundownPerspectiveWidget.h"
...
class WIDGETS_EXPORT RundownPerspectiveWidget : public QWidget, Ui::RundownPerspectiveWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    ...
    public:  
        explicit RundownPerspectiveWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
