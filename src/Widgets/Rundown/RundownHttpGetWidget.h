...
#include "ui_RundownHttpGetWidget.h"
...
class WIDGETS_EXPORT RundownHttpGetWidget : public QWidget, Ui::RundownHttpGetWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownHttpGetWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
